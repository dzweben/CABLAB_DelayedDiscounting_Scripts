...
def convert_txt_to_csv(pid):
    base_dir = "/Users/dannyzweben/Desktop/CABLAB_Files/DelayDiscounting/dd_data/Data/Post-FileSeperation"
    matching_file = None
...
def calculate_indiff_avg(csv_path, pid):
    ...
    if indiff_values:
        ...
        if video_name:
            video_path = f"/Users/dannyzweben/Desktop/CABLAB_Files/DelayDiscounting/dd-conformity-task/ddsocialvideodata/videos/{video_name}"
